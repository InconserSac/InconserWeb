    ...
    <body>
        ...
        <header class="fixed-header">
            <div class="header-container">
                ...
                <div class="user-menu">
                    <% 
    // Obtener el usuario de la sesi髇
    ...
    if (usuario != null) {
                    ...
                    <div class="dropdown-content">
                        ...
                        <form action="../LogoutServlet" method="get">
                            <a href="#"><button style="background-color: red; color: white;" class="logout-btn" type="submit">Cerrar sesi髇</button></a>
                        </form>                           </div>
                        <% 
                            } else {
                        %>
            ...
            <div class="project-list">
                ...
                <div class="project-card" data-status="nuevos">
                    ...
                    <div class="project-overlay">
                        ...
                        <p>Descripci贸n: Construcci贸n de puentes.</p>
                    </div>
                </div>
                <div class="project-card" data-status="nuevos">
                    <img src="../Img/TeamPicture.png" alt="Proyecto 1">
                ...
                <div class="project-card" data-status="proceso">
                    ...
                    <div class="project-overlay">
                        ...
                        <p>Descripci贸n: Infraestructura vial.</p>
                    </div>
                </div>
                <div class="project-card" data-status="proceso">
                    <img src="proyecto2.jpg" alt="Proyecto 2">
                ...
                <div class="project-card" data-status="finalizados">
                    ...
                    <div class="project-overlay">
                        ...
                        <p>Descripci贸n: Sistemas hidr谩ulicos.</p>
                    </div>
                </div>
        ...
        <footer>
            ...
            <div class="footer-info">
                <p>Direcci髇: Av. Santo Toribio 143, piso 12, San Isidro</p>
                <p>Horario de Atenci髇: L-V de 8:00 am a 6:30 pm</p>
            </div>
